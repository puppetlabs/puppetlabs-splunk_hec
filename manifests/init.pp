...
# @param [Optional[Boolean]] fips_crl_check
...
# @param [Optional[Boolean]] fips_verify_peer
...
class splunk_hec (
  ...
  Optional[Boolean] $fips_crl_check                      = true,
  Optional[Boolean] $fips_verify_peer                    = true,
